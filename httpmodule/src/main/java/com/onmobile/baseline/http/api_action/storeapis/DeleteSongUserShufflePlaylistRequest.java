 ...
 */
public class DeleteSongUserShufflePlaylistRequest extends BaseAPIStoreRequestAction {

    private BaselineCallback<String> userDefinedPlaylistDTOBaselineCallback;
    private String udp_id, songId;
    private Call<Void> call;

    public DeleteSongUserShufflePlaylistRequest(String udpid, String song_id, BaselineCallback<String> dtoBaselineCallback) {
    ...
    public void initCall() {
        call = getApi().deleteContentToUserDefinedPlaylist(getBaseStoreURLRequest(), udp_id, songId, getBaseQueryOptions());
    }
