 ...
 */
public class GetPaymentAPIRequest extends BaseAPIStoreRequestAction {

    private static final Logger sLogger = Logger.getLogger(GetPaymentAPIRequest.class);
    private BaselineCallback<PayTMGetPaymentDTO> mCallback;
    ...
    public GetPaymentAPIRequest(PurchaseComboRequestParameters purchaseComboRequestParameters, BaselineCallback<PayTMGetPaymentDTO> callback, ComboApiBillingInfoDto comboApiBillingInfoDto) {
    ...
    public void initCall() {
        call = getApi().getPaymentAPI(getBaseStoreURLRequest(), getAppUtilityOptions(), getBody());
    }
