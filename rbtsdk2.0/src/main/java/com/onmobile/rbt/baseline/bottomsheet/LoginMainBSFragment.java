...
public class LoginMainBSFragment extends BaseBottomSheetFragment<LoginMainBSFragment> implements BottomSheetFragmentListener<BaseFragment, RingBackToneDTO> {
    ...
    public static LoginMainBSFragment newInstance() {
        return new LoginMainBSFragment();
    }

    @NonNull
    @Override
    protected String initTag() {
        return LoginMainBSFragment.class.getSimpleName();
    }
    ...
    protected void bindViews(View view) {
        showTitle();
        addInitialFragment(RegistrationBSFragment.newInstance(FunkyAnnotation.LOGIN_FLOW_LOGIN_CLICK).setCallback(this));
    }
    ...
    @Override
    public LoginMainBSFragment setCallback(OnBottomSheetChangeListener callback) {
