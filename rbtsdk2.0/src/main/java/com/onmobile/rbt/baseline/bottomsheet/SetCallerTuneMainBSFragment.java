...
public class SetCallerTuneMainBSFragment extends BaseBottomSheetFragment<SetCallerTuneMainBSFragment> implements BottomSheetFragmentListener<BaseFragment, RingBackToneDTO> {
    ...
    public static SetCallerTuneMainBSFragment newInstance(String callerSource, RingBackToneDTO ringBackToneDTO) {
        SetCallerTuneMainBSFragment fragment = new SetCallerTuneMainBSFragment();
    ...
    protected String initTag() {
        return SetCallerTuneMainBSFragment.class.getSimpleName();
    }
    ...
    protected void bindViews(View view) {
        ...
        addInitialFragment(
                mRegistrationRequired ?
                        ...
                        SetCallerTunePlansBSFragment.newInstance(mCallerSource, mRingBackToneDTO).setCallback(this)
        );
    }
    ...
    @Override
    public SetCallerTuneMainBSFragment setCallback(OnBottomSheetChangeListener callback) {
    ...
    public void next(BaseFragment fragment, RingBackToneDTO data) {
        ...
        if (fragment instanceof RegistrationBSFragment) {
            nextFragment = SetCallerTunePlansBSFragment.newInstance(mCallerSource, mRingBackToneDTO).setCallback(this);
            sheetCancellable = true;
        } else if (fragment instanceof SetCallerTunePlansBSFragment) {
            hideTitle();
