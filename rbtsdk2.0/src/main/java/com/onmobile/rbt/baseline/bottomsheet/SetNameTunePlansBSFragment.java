...
public class SetNameTunePlansBSFragment extends BaseFragment {
    ...
    public void loadView() {
        ...
        isSelected = AppManager.getInstance().getRbtConnector().isRingbackSelected(mRingBackToneDTO.getId());
        if (isSelected) {
    ...
    private void setTune(AppBaselineCallback<PurchaseComboResponseDTO> callback) {
        ...
        AppManager.getInstance().getRbtConnector().getAppUtilityNetworkRequest(mCallerSource, ringBackToneDTO, pricingSubscriptionDTO, pricingIndividualDTO, contactMap, new AppBaselineCallback<AppUtilityDTO>() {
            ...
            public void success(AppUtilityDTO result) {
                ...
                boolean isAllowed = AppManager.getInstance().getRbtConnector().isThirdPartyPaymentRequired(ringBackToneDTO.getId(), pricingSubscriptionDTO, pricingIndividualDTO);
