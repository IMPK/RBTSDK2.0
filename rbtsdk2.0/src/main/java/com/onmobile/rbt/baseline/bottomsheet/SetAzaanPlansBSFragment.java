...
public class SetAzaanPlansBSFragment extends BaseFragment {
    ...
    public static SetAzaanPlansBSFragment newInstance(String callerSource, RingBackToneDTO ringBackToneDTO) {
        SetAzaanPlansBSFragment fragment = new SetAzaanPlansBSFragment();
    ...
    protected String initTag() {
        return SetAzaanPlansBSFragment.class.getSimpleName();
    }
    ...
    protected void initViews(View view) {
        mShowCaseBuilderManager = new ShowCaseBuilderManager(FunkyAnnotation.TYPE_BS_REG_SET_AZAN, getFragmentContext(), view.findViewById(R.id.layout_showcase_bottom_sheet));
    ...
    public SetAzaanPlansBSFragment setCallback(BottomSheetFragmentListener<BaseFragment, RingBackToneDTO> callback) {
    ...
    private void updatePeekHeight() {
        if (mCallback != null)
            mCallback.updatePeekHeight(SetAzaanPlansBSFragment.this);
    }
...
//                }
                ...
                BaselineApplication.getApplication().getRbtConnector().getRurlResponse(new AppBaselineCallback<RUrlResponseDto>() {
                    ...
                    public void success(RUrlResponseDto result) {
                        ...
                        if (mCallback != null)
                            mCallback.next(SetAzaanPlansBSFragment.this, mRingBackToneDTO);
                    }
                    ...
                    public void failure(String errMsg) {
                        ...
                        if (mCallback != null)
                            mCallback.done(SetAzaanPlansBSFragment.this, mRingBackToneDTO);
//                        if (mCallback != null)
//                            mCallback.done(SetCallerTunePlansBSFragment.this, mRingBackToneDTO);
    ...
    private void purchase(RingBackToneDTO ringBackToneDTO, PricingSubscriptionDTO pricingSubscriptionDTO, PricingIndividualDTO pricingIndividualDTO, Map<String, String> contactMap, AppBaselineCallback<PurchaseComboResponseDTO> callback) {
    ...
    /*Analytics*/
    private void sendConsentAnalytics(String userConsentType, String userConsentResult) {
        RingBackToneDTO ringBackToneDTO = mPlanLayout.getRingBackToneDTO();
//        AnalyticsCloud.getInstance().sendSecondConsentEvent(mCallerSource, mNetworkType, ringBackToneDTO,
//                pricingSubscriptionDTO, pricingIndividualDTO, mSelectedContacts,
//                userConsentType, userConsentResult);
    }

    /*Analytics*/
    private void sendPlanAnalytics(Object obj, String error) {
        //AnalyticsCloud.getInstance().sendPriceDisplayEvent(mCallerSource, obj, error);
    }
...
//        AnalyticsCloud.getInstance().sendPlanUpgradeEvent(mCallerSource, item, pricingSubscriptionDTO, pricingIndividualDTO,
//                mSelectedContacts, fromPlanId, toPlanId, confirm);
    }
