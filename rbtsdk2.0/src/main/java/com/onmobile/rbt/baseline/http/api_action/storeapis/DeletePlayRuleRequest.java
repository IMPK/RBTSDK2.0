...
public class DeletePlayRuleRequest extends BaseAPIStoreRequestAction {
    ...
    private static final Logger sLogger = Logger.getLogger(DeletePlayRuleRequest.class);


    private BaselineCallback<String> mCallback;
    private String ref_id;

    public DeletePlayRuleRequest(PlayRuleDTO playRuleDTO, BaselineCallback<String> callback) {
        ref_id = playRuleDTO.getId();
        mCallback = callback;
        initCall();
    }

    public DeletePlayRuleRequest(String id, BaselineCallback<String> callback) {
        ref_id = id;
        mCallback = callback;
        initCall();
    }
        ...
        call.enqueue(new Callback<Void>() {
            ...
            public void onResponse(Call<Void> call, Response<Void> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    if (mCallback != null) {
                        UserSettingsCacheManager.deletePlayRuleFromCache(ref_id);
    ...
    public void initCall() {
        call = getApi().deletePlayRule(getBaseStoreURLRequest(), ref_id, requestBody());
    }
