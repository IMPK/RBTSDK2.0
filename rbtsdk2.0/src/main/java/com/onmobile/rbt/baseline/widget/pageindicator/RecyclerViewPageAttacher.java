...
public class RecyclerViewPageAttacher implements PageIndicator.PagerAttacher<RecyclerView> {
     ...
     */
    public RecyclerViewPageAttacher() {
     ...
     */
    public RecyclerViewPageAttacher(int currentPageLeftCornerX) {
        this.currentPageLeftCornerX = currentPageLeftCornerX;
        this.centered = false;
    }

    @Override
    public void attachToPager(@NonNull final PageIndicator indicator, @NonNull final RecyclerView pager) {
