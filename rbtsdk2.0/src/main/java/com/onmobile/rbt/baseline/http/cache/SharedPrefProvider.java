...
public class SharedPrefProvider {
    public static final String baseline_appconfig = "baseline_appconfig";
    SharedPreferences sharedpreferences;
    public static SharedPrefProvider INSTANCE;

    public SharedPrefProvider(Context context) {
        this.sharedpreferences = context.getSharedPreferences(baseline_appconfig, Context.MODE_PRIVATE);
    }
    ...
    public <T> void writeSharedList(String key, List<T> value) {
        Gson gson = new Gson();
        String objectValue = gson.toJson(value);
