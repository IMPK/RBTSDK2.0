 ...
 */
public class GetDetailUserShufflePlaylistRequest extends BaseAPIStoreRequestAction {

    private BaselineCallback<UdpDetailDTO> userDefinedPlaylistDTOBaselineCallback;
    private Call<UdpDetailDTO> call;
    private String udp_id;

    public GetDetailUserShufflePlaylistRequest(String udpid, BaselineCallback<UdpDetailDTO> dtoBaselineCallback) {
    ...
    public void execute() {
        retryCount++;
        call.enqueue(new Callback<UdpDetailDTO>() {
            @Override
            ...
            @Override
            public void onFailure(Call<UdpDetailDTO> call, Throwable t) {
    ...
    public void initCall() {
        call = getApi().getUdpDetailPlaylist(getBaseStoreURLRequest(), udp_id, getBaseQueryOptions());
    }
